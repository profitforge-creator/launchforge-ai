...
// Responses reference the actual business context so they feel personalized.
...
interface ResponseMatch {
  pattern: RegExp;
  generate: (msg: string, ctx: BusinessResult) => string;
}
...
const MATCHERS: ResponseMatch[] = [
  ...
  {
    pattern: /landing.?page|sales.?page|copy|headline|convert/i,
    generate: (_msg, ctx) =>
